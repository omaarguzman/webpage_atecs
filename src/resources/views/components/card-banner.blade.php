<div class="max-w-6xl bg-white border border-gray-200 rounded-none shadow">
    <div class="p-5">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-jmapaBlueDark">Nuevo Banner</h5>
        <form wire:submit.prevent="save">
                ...
                <div class="flex flex-row items-center">
                    ...
                    <div class="w-full basis-1/2 px-2">
                        <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                            ...
                            <!-- File Input -->
                            <x-input-label for="img" :value="__('Imagen del banner')" />
                        ...
                        <div>
                            <label for="activo" class="inline-flex items-center">
                                <input wire:model="activo" id="activo" type="checkbox"
                                    ...
                                    name="activo">
                                <span class="ms-2 text-sm text-gray-600">{{ __('¿Banner activo?') }}</span>
                            </label>
            ...
            <div class="mt-4 flex justify-end">
                <!-- Boton guardar -->
                <div class="mr-2">
                    <!-- <x-primary-button class="ms-3 bottom-0 right-0" wire:click.prevent="save()">
                        {{ __('Guardar') }}
                    </x-primary-button> -->
