                                    ...
                                    @foreach ($banners as $banner)
                                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                                <img src="{{ $banner->img }}" class="w-20 rounded mx-auto"
                                                    alt="{{ $banner->titulo }}" />
                                            </td>
                                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                                {{ $banner->titulo }}
                                            ...
                                            <td class=" p-5 ">
                                                <div class="flex items-center gap-1">
                                                    <button
                                                        ...
                                                        <x-icon name="pencil" class="w-5 h-5 inline -mt-1" color="#ffffff" />
                                                    </button>
                                                    <button wire:click.prevent="deleteBanner({{ $banner->id }})"
                                                        ...
                                                        <x-icon name="trash" class="w-5 h-5 inline -mt-1" color="#ffffff" />
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
